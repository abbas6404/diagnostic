...
class OpdInvoiceHelper
{
    /**
     * Generate OPD invoice number with consistent format
     * Uses the format setting from database
     */
    public static function generateOpdInvoiceNumber()
    {
        $prefix = SystemSetting::getValue('opd_prefix', 'OPD');
        $startNumber = (int) SystemSetting::getValue('opd_start', '1');
