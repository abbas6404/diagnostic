<?php $__env->startSection('title', 'Diagnostics Invoice'); ?>
...
[$__name, $__params] = $__split('patient-search');

$__html = app('livewire')->mount($__name, $__params, 'lw-1362480349-0', $__slots ?? [], get_defined_vars());
...
?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="date" class="form-control form-control-sm" value="<?php echo e(date('Y-m-d')); ?>" name="invoice_date" tabindex="9">
...
[$__name, $__params] = $__split('ticket-search');

$__html = app('livewire')->mount($__name, $__params, 'lw-1362480349-1', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('doctor-search');

$__html = app('livewire')->mount($__name, $__params, 'lw-1362480349-2', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('pcp-search');

$__html = app('livewire')->mount($__name, $__params, 'lw-1362480349-3', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('lab-test-search');

$__html = app('livewire')->mount($__name, $__params, 'lw-1362480349-4', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('search-results');

$__html = app('livewire')->mount($__name, $__params, 'lw-1362480349-5', $__slots ?? [], get_defined_vars());
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\aioli\Herd\diagnostic\resources\views/admin/diagnostics/invoice/index.blade.php ENDPATH**/ ?>