    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="ms-3 d-none d-lg-block">
                <h5 class="mb-0 fw-bold"><?php echo $__env->yieldContent('title'); ?></h5>
            </div>
            ...
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item dropdown profile-dropdown">
                    <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-none d-md-flex flex-column ms-1 me-1">
                                <span class="fw-medium text-dark" style="font-size: 14px; line-height: 1.2"><?php echo e(Auth::user()->name); ?></span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <div class="p-1">
                            <a class="dropdown-item rounded-3" href="<?php echo e(route('admin.profile.index')); ?>">
                                <i class="fas fa-user"></i> My Profile
                            </a>
                            <a class="dropdown-item rounded-3" href="<?php echo e(route('admin.profile.password')); ?>">
                            ...
                            <a class="dropdown-item rounded-3" href="<?php echo e(route('logout')); ?>"
...
</nav> <?php /**PATH C:\Users\aioli\Herd\diagnostic\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>