        ...
        <div class="card shadow">
            <div class="card-header bg-white py-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="<?php echo e(route('admin.doctor.invoice')); ?>" class="btn btn-sm btn-outline-secondary me-2">
                        ...
                        <div class="card border mb-3">
                            <div class="card-header bg-primary text-white py-2">
                                <h6 class="mb-0">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if(empty($searchInvoices)): ?>
                                        Recent Invoices
                                    <?php else: ?>
                                        Search Results for '<?php echo e($searchInvoices); ?>'
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </h6>
                            </div>
                            <div class="card-body p-0" style="height: 250px; overflow-y: auto;">
                                <div id="search-results-body">
                                    <!--[if BLOCK]><![endif]--><?php if(count($invoiceSearchResults) > 0): ?>
                                        <div class="table-responsive">
                                            <table class="table table-sm table-hover mb-0">
                                                ...
                                                <tbody>
                                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $invoiceSearchResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr class="search-item" wire:click="selectInvoice(<?php echo e($invoice['invoice_id']); ?>)" style="cursor: pointer;">
                                                            <td class="fw-bold">
                                                                <div class="triangle-indicator"></div><?php echo e($invoice['invoice_no']); ?>

                                                            </td>
                                                            <td><?php echo e($invoice['patient_name'] ?? 'N/A'); ?></td>
                                                            <td class="text-end"><?php echo e(number_format($invoice['total_amount'], 0)); ?></td>
                                                            <td class="text-end text-success"><?php echo e(number_format($invoice['paid_amount'], 0)); ?></td>
                        ...
                        <div class="card border">
                            ...
                            <div class="card-body">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm text-end fw-bold" 
                                               value="<?php echo e(number_format($total_amount, 2)); ?>" readonly>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm text-end fw-bold text-success" 
                                               value="<?php echo e(number_format($paid_amount, 2)); ?>" readonly>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm text-end fw-bold text-danger" 
                                               value="<?php echo e(number_format($due_amount, 2)); ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-center gap-2 mt-4">
                                    <button class="btn btn-success" wire:click="printInvoice" 
                                            <?php if(!$selectedInvoiceId): ?> disabled <?php endif; ?>>
...
</div> <?php /**PATH C:\Users\aioli\Herd\diagnostic\resources\views/livewire/doctor-re-print.blade.php ENDPATH**/ ?>