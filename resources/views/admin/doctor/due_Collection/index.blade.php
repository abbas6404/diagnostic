...
@section('title', 'Doctor/Consultant Due Collection')
        ...
        <div class="card-header bg-white py-3">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0 text-primary">
                    <i class="fas fa-user-md me-2"></i> Doctor/Consultant Due Collection
                </h5>
                <div>
                    ...
                    <a href="#" class="btn btn-sm btn-primary">
                        <i class="fas fa-file-invoice me-1"></i> New Consultation
                    </a>
                </div>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <div class="card border mb-3">
                        <div class="card-header bg-light py-2">
                            <h6 class="mb-0"><i class="fas fa-file-invoice me-1"></i> Due Consultations</h6>
                        </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="8" class="text-center text-muted py-4">
                                                ...
                                                Search for a patient or consultation to view due amounts
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="card border">
                        <div class="card-header bg-light py-2">
                            <h6 class="mb-0"><i class="fas fa-list-alt me-1"></i> Consultation Details</h6>
                        </div>
                        <div class="card-body p-0">
                            <div class="table-responsive" style="max-height: 300px; overflow-y: auto;">
...
function loadInvoiceDetails(invoiceId) {
    ...
    fetch(`/admin/doctor/duecollection/invoice/${invoiceId}/details`)
...
function updateInvoiceDetailsTable(details) {
    ...
    if (details.length === 0) {
        tbody.innerHTML = `
            <tr>
                <td colspan="6" class="text-center text-muted py-4">
                    No consultation details found for this invoice
                </td>
            </tr>
        `;
        return;
    ...
    details.forEach(item => {
        ...
        const ticketDate = item.ticket_date || '';
        const ticketTime = item.ticket_time || '';
        const dateTimeStr = ticketDate && ticketTime ? `${ticketDate} ${ticketTime}` : (ticketDate || ticketTime || '-');
