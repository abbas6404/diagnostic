...
@section('page-title', 'Edit OPD Service')
@section('page-description', 'Update OPD service information')

@section('setup-content')
<div class="card shadow">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">
            <i class="fas fa-edit me-2"></i>Edit OPD Service
        </h6>
    </div>
    <div class="card-body">
        @if(session('error'))
        ...
        <form action="{{ route('admin.setup.opd-service.update', $opdService) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               id="code" 
                               name="code" 
                               value="{{ old('code', $opdService->code) }}" 
                        ...
                        <select class="form-select @error('department_id') is-invalid @enderror" 
                            ...
                            @foreach($departments as $department)
                                <option value="{{ $department->id }}" 
                                        {{ old('department_id', $opdService->department_id) == $department->id ? 'selected' : '' }}>
                                    {{ $department->name }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div class="mb-3">
                ...
                <input type="text" 
                       ...
                       id="name" 
                       name="name" 
                       value="{{ old('name', $opdService->name) }}" 
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" 
                          ...
                          name="description" 
                          rows="3" 
                          placeholder="Enter service description">{{ old('description', $opdService->description) }}</textarea>
                @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="number" 
                           ...
                           id="charge" 
                           name="charge" 
                           value="{{ old('charge', $opdService->charge) }}" 
                           placeholder="0.00"
                           step="0.01"
                           min="0"
                           required>
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-1"></i>Update OPD Service
                </button>
            </div>
        </form>
    </div>
