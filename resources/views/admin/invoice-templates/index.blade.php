                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <a href="{{ route('admin.admin.invoice-templates.default') }}" class="btn btn-primary btn-sm">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <a href="{{ route('admin.admin.invoice-templates.compact') }}" class="btn btn-success btn-sm">
                                <i class="fas fa-eye me-1"></i> View Template
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <a href="{{ route('admin.admin.invoice-templates.professional') }}" class="btn btn-info btn-sm">
                                <i class="fas fa-eye me-1"></i> View Template
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <a href="{{ route('admin.admin.invoice-templates.receipt') }}" class="btn btn-warning btn-sm">
                                <i class="fas fa-eye me-1"></i> View Template
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <a href="{{ route('admin.admin.invoice-templates.laboratory') }}" class="btn btn-danger btn-sm">
                                <i class="fas fa-eye me-1"></i> View Template
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <a href="{{ route('admin.admin.invoice-templates.doctor-consultant') }}" class="btn btn-primary btn-sm">
                                <i class="fas fa-eye me-1"></i> View Template
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <a href="{{ route('admin.admin.invoice-templates.test') }}" class="btn btn-secondary btn-sm">
                                <i class="fas fa-eye me-1"></i> View Template
                            </a>
                        </div>
                    </div>
