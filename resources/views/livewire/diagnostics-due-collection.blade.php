        ...
        <div class="card-header bg-white py-3">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0 text-primary">
                    <i class="fas fa-vial me-2"></i> Diagnostics Due Collection
                </h5>
                <div>
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control form-control-sm" wire:model="age_years" placeholder="Y" readonly>
                                                <input type="text" class="form-control form-control-sm" wire:model="age_months" placeholder="M" readonly>
                                                <input type="text" class="form-control form-control-sm" wire:model="age_days" placeholder="D" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control form-control-sm" wire:model="patient_address" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card border">
                        <div class="card-header bg-light py-2">
                            <h6 class="mb-0"><i class="fas fa-vial me-1"></i> Lab Tests</h6>
                        </div>
                        <div class="card-body p-0">
                            <div class="table-responsive" style="max-height: 300px; overflow-y: auto;">
                                        ...
                                        @if(count($labTests) > 0)
                                            @foreach($labTests as $test)
                                                <tr>
                                                    ...
                                                    <td class="text-end">{{ number_format($test['charge'] ?? 0, 0) }}</td>
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="5" class="text-center text-muted py-4">
                                                    ...
                                                    Select an invoice to view lab tests
                                                </td>
                                            </tr>
                                        @endif
                                    </tbody>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-7">
                                    <input type="number" class="form-control form-control-sm text-end" 
                                           wire:model.live="collectionAmount" step="0.01" min="0">
                                </div>
                            </div>
    ...
    document.addEventListener('livewire:init', () => {
        ...
        Livewire.on('openPrintWindow', (data) => {
            if (data.invoiceId) {
                ...
                console.log('Opening print window for due collection:', templateUrl);
